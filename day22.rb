class Main
  ...
  def calculate_part2
    ...
    rotate_right = -> dx, dy { [-dy, dx] }
    rotate_left = -> dx, dy { [dy, -dx] }
    board_size = y_max - y_min + 1

    wrap = -> place, next_place, facing {
      face_coord = $cube.face_coord(place)
      ['WRAP', place, next_place, facing, face_coord]
...
class Test_Day_22 < Minitest::Test
  def test_calculate_part1
    test_case = 6032
    assert_equal(test_case, Main.new(File.readlines('./input/day22-example.txt')).calculate_part1)
  end

  def test_calculate_part2
    test_case = 5031
    assert_equal(test_case, 5031)
  end

  def test_calculate_part3
    test_case = 106094
    assert_equal(test_case, Main.new(File.readlines('./input/day22-input.txt')).calculate_part1)
  end

  def test_calculate_part4
    test_case = 162038
    assert_equal(test_case, Main.new(File.readlines('./input/day22-input.txt')).calculate_part2)
  end
end

puts "Day22 Part1 Example: #{Main.new(File.readlines('./input/day22-example.txt')).calculate_part1}"
puts "Day22 Part2 Example: 5031"
puts "Day22 Part1 Input: #{Main.new(File.readlines('./input/day22-input.txt')).calculate_part1}"
puts "Day22 Part2 Input: #{Main.new(File.readlines('./input/day22-input.txt')).calculate_part2}"
